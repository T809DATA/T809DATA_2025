...
* `E_total` is an array of the average cross-entropy per sample after each iteration.
...
* `W1tr`:
```
[[-0.78668809  0.23806341  0.08544919  0.55342402  0.78153024 -0.34151507]
 [-0.66705624  0.57640924  1.10220182  0.67437143  0.26499546  0.31100486]
 [-0.52803262  0.40394402  0.59590789  0.06255936  1.0790303  -0.7069952 ]
 [ 1.83048698  0.76265828 -1.60160006  0.22110312 -2.00102918 -0.35696303]
 [ 1.38826261  0.30365358 -0.73820746  0.57905365 -0.87599253  0.09068115]]
```
* `W2tr`:
```
[[ 0.64327935 -0.61265728  0.09847553]
 [-3.2110483   0.85145902  1.54212541]
 [-0.6686751   0.3706022  -0.61559683]
 [ 2.02354155 -0.23463302 -2.7566989 ]
 [-1.02469617 -0.12811572 -0.29869961]
 [ 2.18675521 -2.04123674 -0.92624345]
 [-0.3506745   0.15976864 -0.9120843 ]]
```
* `Etotal`:
```
[2.08602586 2.0119761 1.95583621 1.91248967 1.87829846 1.85077295,
...
0.81099647 0.81003593 0.80907363 0.8081096 0.80714383 0.80617633]
```
* `misclassification_rate`:
```
[0.6 0.6 0.6 0.6 0.6 0.55 0.5 0.4 0.3 0.3 0.3 0.25 0.25 0.25,
...
0.25 0.25 0.25 0.25 0.25 0.25 0.25 0.25 0.25 0.25]
```
* `last_guesses`:
```
[1 1 1 0 1 0 0 0 1 1 1 0 1 1 0 1 1 0 1 1]
```
